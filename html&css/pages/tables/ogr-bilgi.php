            ...
            <div class="table-responsive">
                <table class="table table-centered mb-s rounded">
                    <thead class="thead-light">
                        <tr>
                           <th class="border-0">Öğretmen Adı</th>
                           <th class="border-0">Öğretmen Soy Adı</th>
                           <th class="border-0">Öğrenci Sayısı</th>
                           <th class="border-0">Öğrenci Ekle</th>
                        </tr>
                    </thead>
                            <tbody>
                                <!-- Item -->
                                <tr>
                                    <td>
                                      <input type="text" id="kullanici-form-box" name="ogrAdı">
                                    </td>
                                    <td>
                                      <input type="text" id="kullanici-form-box" name="Soyad">
                                    </td>
                                    <td>
                                        <input type="text" id="kullanici-form-box" name="ad" disabled>
                                      </td>
                                      <td>
                                    <button onclick="location.href='../../pages/tables/ogretmen-ata.html'" style="background-color:#08593e;"  type="button" id="kullanici-form-button"> EKLE</button>
                                   </td>
                                </tr>
                                <!-- End of Item -->
                            </tbody>
